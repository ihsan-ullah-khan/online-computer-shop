        ...
        <div class="flex overflow-hidden rounded-lg">
            <div class="w-full p-4">
                <form method="POST" action="{{ route('categories.update', $category) }}">
                    ...
                    <!-- Name -->
                    <div>
                        <x-label class="inline-block w-full text-sm my-6 text-gray-700 dark:text-gray-400" for="category_name"
                                 :value="('Category_Name')"/>

                        <x-input id="category_name"
                                 class="inline-block m-4 w-full text-black text-sm dark:border-gray-600 dark:bg-gray-700 focus:outline-none  focus:ring  focus:ring-opacity-50 @error('name') focus:border-red-400 focus:shadow-outline-red focus:ring-red-200 @else focus:border-purple-400 focus:shadow-outline-purple focus:border-indigo-300 focus:ring-indigo-200 @enderror dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                 type="text"
