                        ...
                        @forelse($messages as $message)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="font-semibold">{{ $message->created_at }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 w-12">
                                    <div class="flex justify-end space-x-4 text-sm">
                                        <a href="javascript:void(0);"
                                           onclick="if(window.confirm('Are you sure you want to delete this question?')){ document.getElementById('delete-{{ $message->id }}').submit();  }"
                                        ...
                                        <form method="post" id="delete-{{ $message->id }}"
