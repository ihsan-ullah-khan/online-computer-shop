                ...
                <div class="w-full overflow-x-auto">
                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        >
                            ...
                            <th class="px-4 py-3 w-12">Name</th>
                            <th class="px-4 py-3">Address</th>
                            <th class="px-4 py-3 w-12">Payment Method</th>
                                    ...
                                    <div class="flex items-center text-sm">
                                        <div>
                                            ...
                                            @elseif($order->status == 'R')
                                                <span
                                                    class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700">Returned</span>
                                            @endif
                                        </div>
                                    </div>
                                </td>
